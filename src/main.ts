...
class TestReporter {
  ...
  readonly commentBody = core.getInput('comment-body', {required: false})
  readonly repository = core.getInput('repository', {required: false})
  readonly issueNumber = core.getInput('issue-number', {required: false})
